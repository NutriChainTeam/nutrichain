import{cv as g,cK as C,cL as w,cN as k,cO as $,cQ as m,cR as d,cF as l}from"./main-fJPeS9Wm.js";import{n as x,c as f,r as v}from"./index-D1QK5nkj.js";import{o as z}from"./if-defined-B62JGHpA.js";import{e as O,n as _}from"./ref-BbokaMLN.js";const h=g({isLegalCheckboxChecked:!1}),u={state:h,subscribe(e){return w(h,()=>e(h))},subscribeKey(e,t){return C(h,e,t)},setIsLegalCheckboxChecked(e){h.isLegalCheckboxChecked=e}},E=k`
  label {
    display: inline-flex;
    align-items: center;
    cursor: pointer;
...
`;var b=function(e,t,o,n){var s=arguments.length,c=s<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,o):n,i;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")c=Reflect.decorate(e,t,o,n);else for(var r=e.length-1;r>=0;r--)(i=e[r])&&(c=(s<3?i(c):s>3?i(t,o,c):i(t,o))||c);return s>3&&c&&Object.defineProperty(t,o,c),c};const R={lg:"md",md:"sm",sm:"sm"};let a=class extends m{constructor(){super(...arguments),this.inputElementRef=O(),this.checked=void 0,this.disabled=!1,this.size="md"}render(){const t=R[this.size];return d`
    ...
    `}dispatchChangeEvent(){this.dispatchEvent(new CustomEvent("checkboxChange",{detail:this.inputElementRef.value?.checked,bubbles:!0,composed:!0}))}};a.styles=[$,E];b([x({type:Boolean})],a.prototype,"checked",void 0);b([x({type:Boolean})],a.prototype,"disabled",void 0);b([x()],a.prototype,"size",void 0);a=b([f("wui-checkbox")],a);const L=k`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
