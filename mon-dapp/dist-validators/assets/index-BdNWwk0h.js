import{cT as p,cQ as u,cV as f,d9 as g,cR as a}from"./main-fJPeS9Wm.js";import{n as b,r as m,c as w}from"./index-D1QK5nkj.js";import{T as l}from"./index-Cfufyr7p.js";const C={interpolate(r,e,t){if(r.length!==2||e.length!==2)throw new Error("inputRange and outputRange must be an array of length 2");const n=r[0]||0,i=r[1]||0,o=e[0]||0,s=e[1]||0;return t<n?o:t>i?s:(s-o)/(i-n)*(t-n)+o}},v=p`
  :host {
    width: 100%;
    display: block;
  }
