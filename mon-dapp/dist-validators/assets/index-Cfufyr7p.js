import{cU as d,cv as h,cK as f,cL as g,cN as w,cQ as b,cR as y}from"./main-fJPeS9Wm.js";import{r as m,c as v}from"./index-D1QK5nkj.js";const o=h({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),x={state:o,subscribe(t){return g(o,()=>t(o))},subscribeKey(t,e){return f(o,t,e)},showTooltip({message:t,triggerRect:e,variant:i}){o.open=!0,o.message=t,o.triggerRect=e,o.variant=i},hide(){o.open=!1,o.message="",o.triggerRect={width:0,height:0,top:0,left:0}}},s=d(x),$=w`
  :host {
    pointer-events: none;
  }
