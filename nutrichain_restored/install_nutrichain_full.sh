...
echo "=========================================="
echo "🍽️  NutriChain - Installation Complète"
echo "=========================================="
echo ""
...
<head>
    ...
    <style>
        ...
        .donation-item { background-color: #1f2937; border-left: 4px solid #10b981; padding: 16px; margin-bottom: 12px; border-radius: 8px; }
        .meal-item { background-color: #1f2937; border-left: 4px solid #f59e0b; padding: 12px; margin-bottom: 8px; border-radius: 6px; }
    </style>
</head>
<body>
    <div class="sidebar">
        ...
        <div class="p-8">
            ...
            <div id="dashboardSection" class="section">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="stat-card">
                        <div class="flex justify-between items-start mb-3">
                            <div class="text-gray-400 text-sm">Personnes Aidées</div>
                            <i data-lucide="users" class="w-8 h-8 text-purple-400"></i>
                        </div>
                        <div class="text-4xl font-bold text-white">4,521</div>
                        <div class="text-xs text-gray-400 mt-2">Dans 12 pays</div>
                    </div>
                    <div class="stat-card">
                        <div class="flex justify-between items-start mb-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="card">
                        ...
                        <p class="text-gray-400 text-sm mb-4">Chaque token finance directement un repas</p>
                        <button onclick="showSection('donate')" class="btn-primary w-full">Donner Maintenant</button>
                    </div>
                    <div class="card">
                        <h3 class="text-xl font-bold text-white mb-4 flex items-center">
                            <i data-lucide="coins" class="w-6 h-6 mr-2 text-orange-400"></i>Staking Solidaire
                        </h3>
                        <p class="text-gray-400 text-sm mb-4">Vos récompenses nourrissent les nécessiteux</p>
                        <button onclick="showSection('staking')" class="btn-secondary w-full">Staker</button>
                    </div>
                    <div class="card">
                        <h3 class="text-xl font-bold text-white mb-4 flex items-center">
                            <i data-lucide="search-check" class="w-6 h-6 mr-2 text-cyan-400"></i>Transparence
                        </h3>
                        <p class="text-gray-400 text-sm mb-4">Suivez chaque don sur la blockchain</p>
                        <button onclick="showSection('transparency')" class="btn-primary w-full">Explorer</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <form class="space-y-4">
                            <div>
                                ...
                                <input type="number" id="donateAmount" placeholder="10" min="1">
                    ...
                    <div class="meal-item">
                        <div class="flex justify-between">
                            <div>
                                ...
                                <div class="text-xs text-gray-400">Restos du Cœur - Paris</div>
                            </div>
                    ...
                    <div class="meal-item">
                        <div class="flex justify-between">
                            <div>
                                ...
                                <div class="text-xs text-gray-400">Cantine Al-Amal - Syrie</div>
                            </div>
            ...
            <div id="transparencySection" class="section" style="display:none;">
                ...
                <div class="card">
                    <div class="donation-item">
                        <div class="text-sm mb-1"><strong>Don:</strong> 100 NUTRI → Éthiopie</div>
                        <div class="text-xs text-gray-400 font-mono">Hash: 0x7a3f...d9e2</div>
                    </div>
                    <div class="donation-item">
                        <div class="text-sm mb-1"><strong>Don:</strong> 50 NUTRI → Secours Catholique</div>
                        <div class="text-xs text-gray-400 font-mono">Hash: 0x2b8c...f4a1</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="bg-blue-900/20 border border-blue-700 rounded-lg p-4 mb-4">
                            <ul class="space-y-2 text-sm text-blue-200">
                                <li>✓ Stakez vos tokens</li>
                                <li>✓ Gagnez 7% APY</li>
                                <li>✓ Récompenses = repas gratuits</li>
                            </ul>
                        </div>
                        <form class="space-y-4">
                            <div>
                                <label class="block text-gray-400 mb-2">Montant</label>
                                <input type="number" placeholder="100" min="1">
                            </div>
                            <button type="submit" class="btn-primary w-full">
                                <i data-lucide="coins" class="w-5 h-5 inline mr-2"></i>Staker
                            </button>
                        </form>
                    </div>
                    <div class="card">
                        ...
                        <div class="bg-[#1f2937] p-4 rounded-lg">
                            <div class="text-gray-400 text-sm mb-1">Repas Financés</div>
                ...
                <div class="card">
                    <div class="flex justify-between items-start mb-3">
                        <div>
                            ...
                            <p class="text-sm text-gray-400">Programme d'urgence Tigré</p>
                        </div>
                        <span class="text-xs bg-green-900/30 text-green-400 px-3 py-1 rounded-full">Actif</span>
                    </div>
                    <div class="flex gap-2">
                        <button class="btn-primary flex-1">Voter Pour</button>
                        <button class="btn-secondary flex-1">Voter Contre</button>
                    </div>
                </div>
            </div>
        </div>
